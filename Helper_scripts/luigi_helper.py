...
from tierpsytools.read_data.get_timeseries import (read_timeseries, get_timeseries)
...
if __name__ == "__main__":
    RAW_DATA_DIR = Path('/Volumes/behavgenom$/Tom/Data/Hydra/imb-2/hetrozygotes_screening/Results')
    # RAW_DATA_DIR = Path('/Users/tobrien/Documents/Imperial : MRC/TNPO2 Consultancy Project/heterozygoutes_screening/Results')
    METADATA_FILE = Path('/Volumes/behavgenom$/Tom/Data/Hydra/imb-2/hetrozygotes_screening/AuxiliaryFiles/metadata.csv')
    # METADATA_FILE = Path('/Users/tobrien/Documents/Imperial : MRC/TNPO2 Consultancy Project/heterozygoutes_screening/metadata.csv')
    CONTROL_STRAIN = 'N2'
    CANDIDATE_GENE='imb-2'
    ...
    meta.worm_gene.replace({'N2-KRA443':'N2',
                    'imb-2-KRA443':'imb-2'},
                    inplace=True)
