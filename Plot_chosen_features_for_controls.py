...
Plotting chosen behavioural features for H828Q and WT strains in the absence 
of treatment with CuCl2 (i.e. untreated controls)
...
save_dir = Path('/Users/tobrien/Documents/Imperial : MRC/cua-1/Paper_figures/no_compound_control')

CONTROL_STRAIN = 'WT'  

# Choose features to be plotted
...
if __name__ == '__main__':
    ...
    # Read in data and align by bluelight using tierpsy tools function
    feat, meta = read_hydra_metadata(
        FEAT_FILE,
        FNAME_FILE,
        METADATA_FILE)

    # Align feature matrix by recording period i.e. prestim, blue light etc.
    feat, meta = align_bluelight_conditions(feat, meta, how='inner')
    
    # rename strains to fit with paper nomenclature:
    ...
    for f in FEATURE:
        ...
        # Fit plot into figure size and save
        plt.tight_layout()
